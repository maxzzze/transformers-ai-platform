...
def main():
    ...
    parser.add_argument("--bucket", default=None, type=str, required=False,
                        help="The bucket to copy everything to at the end.")
    ## Other parameters
    ...
    # parser.add_argument("--slack_channel", default=None, type=str, required=True)
    # parser.add_argument("--slack_webhook_url", default=None, type=str, required=True)
    # args = parser.parse_args()
    # os.environ["SLACK_WEBHOOK_URL"] = args.slack_webhook_url
    # os.environ["SLACK_CHANNEL"] = args.slack_channel
    run_main(args)
...
def run_main(args):
    ...
    #TODO write args to output directory
    ...
    if args.local_rank == -1 or args.no_cuda:
        ...
        logger.info("Detectiong {} GPUs".format(args.n_gpu))
    ...
    # Training
    if args.do_train:
        train_dataset = load_and_cache_examples(args, processor, args.task_name, tokenizer, evaluate=False)
